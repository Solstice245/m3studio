...
class Properties(shared.M3BoneUserPropertyGroup):
    ...
    box_offset_x_left: bpy.props.FloatProperty(name='M3 Splat Left', default=2.5)
    box_offset_x_right: bpy.props.FloatProperty(name='M3 Splat Right', default=2.5)
    box_offset_y_front: bpy.props.FloatProperty(name='M3 Splat Front', default=2.5)
    box_offset_y_back: bpy.props.FloatProperty(name='M3 Splat Back', default=2.5)

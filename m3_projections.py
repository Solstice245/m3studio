...
class Properties(shared.M3BoneUserPropertyGroup):
    ...
    box_offset_z_bottom: bpy.props.FloatProperty(name='M3 Splat Bottom', min=0, default=0.25)
    box_offset_z_top: bpy.props.FloatProperty(name='M3 Splat Top', min=0, default=0.25)
    box_offset_x_left: bpy.props.FloatProperty(name='M3 Splat Left', min=0, default=2.5)
    box_offset_x_right: bpy.props.FloatProperty(name='M3 Splat Right', min=0, default=2.5)
    box_offset_y_front: bpy.props.FloatProperty(name='M3 Splat Front', min=0, default=2.5)
    box_offset_y_back: bpy.props.FloatProperty(name='M3 Splat Back', min=0, default=2.5)
    ...
    attenuation_plane_distance: bpy.props.FloatProperty(options=set(), min=0, default=1)

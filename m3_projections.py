...
class Properties(shared.M3BoneUserPropertyGroup):
    ...
    box_offset_z_header: bpy.props.PointerProperty(type=shared.M3AnimHeaderProp)
    ...
    box_offset_x_header: bpy.props.PointerProperty(type=shared.M3AnimHeaderProp)
    ...
    box_offset_y_header: bpy.props.PointerProperty(type=shared.M3AnimHeaderProp)

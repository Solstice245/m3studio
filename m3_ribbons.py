...
def draw_point_props(point, layout):
    ...
    layout.separator()
    layout.prop(point, 'emission_offset', text='Emission Offset')
    layout.separator()
    layout.prop(point, 'emission_vector', text='Emission Vector')
    layout.separator()
    ...
    layout.separator()
    row = shared.draw_prop_split(layout, flow='row', align=True, text='Yaw/Pitch')
...
def draw_ribbon_props(ribbon, layout):
    ...
    layout.separator()
    row = shared.draw_prop_split(layout, flow='row', align=True, text='Scale Smoothing')

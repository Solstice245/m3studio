...
def draw_props(particle, layout):
    ...
    row.prop(particle, 'emit_speed_random', text='')
    sub = row.column(align=True)
    sub.active = particle.emit_speed_random
    sub.prop(particle, 'emit_speed_max', text='')
    col.separator()
    ...
    row = col.row(align=True, heading='Randomize')
    row.prop(particle, 'lifespan_random', text='')
    sub = row.column(align=True)
    sub.active = particle.lifespan_random
    sub.prop(particle, 'lifespan_max', text='')
    col.separator()
    col.prop(particle, 'mass', text='Mass')
    row = col.row(align=True, heading='Randomize')
    row.prop(particle, 'mass_random', text='')
    sub = row.column(align=True)
    sub.active = particle.mass_random
    sub.prop(particle, 'mass_max', text='')
    col.separator()
    ...
    row = col.row(align=True, heading='Randomize')
    row.prop(particle, 'color_random', text='')
    sub = col.column(align=True)
    sub.active = particle.color_random
    ...
    row = col.row(align=True, heading='Randomize')
    row.prop(particle, 'rotation_random', text='')
    sub = col.column(align=True)
    sub.active = particle.rotation_random
    ...
    row = col.row(align=True, heading='Randomize')
    row.prop(particle, 'size_random', text='')
    sub = col.column(align=True)
    sub.active = particle.size_random
...
class Properties(shared.M3BoneUserPropertyGroup):
    ...
    emit_speed_max: bpy.props.FloatProperty(name='Particle Emission Speed Random', default=1)
    emit_speed_random: bpy.props.BoolProperty(options=set())
    ...
    lifespan_max: bpy.props.FloatProperty(name='Particle Lifespan Random', default=1, min=0)
    lifespan_random: bpy.props.BoolProperty(options=set())
    gravity: bpy.props.FloatProperty(options=set())
    mass: bpy.props.FloatProperty(options=set())
    mass_max: bpy.props.FloatProperty(options=set(), default=1)
    mass_random: bpy.props.BoolProperty(options=set())
    ...
    color_random: bpy.props.BoolProperty(options=set())
    ...
    rotation_random: bpy.props.BoolProperty(options=set())
    ...
    size_random: bpy.props.BoolProperty(options=set())
